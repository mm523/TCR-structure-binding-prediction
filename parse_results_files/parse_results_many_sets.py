...
def parse_results(folder, out_name, set):
    ...
    for idx, f in enumerate(os.listdir(folder)):
        id = f.split("_log")[0]
        my_file = id + "_log-all_templ_" + set + ".txt"
        print(my_file)
        idx1 += 1
        template = ""
        dec_function = ""
...
out_b10x = "path_to_folder/B10x/B10x_prediction_results_at_" + set + ".csv"
out_dash = "path_to_folder/Dash/Dash_prediction_results_at_" + set + ".csv"
out_expt = "path_to_folder/expt/expt_prediction_results_at_" + set + ".csv"
out_atlas = "path_to_folder/atlas/atlas_prediction_results_at_" + set + ".csv"
# out_os = "path_to_folder/OS/OS_prediction_results_at_" + set + ".csv"
# out_zhang = "path_to_folder/zhang/zhang_prediction_results_at_" + set + ".csv"
out_newVdj = "path_to_folder/newVdj/newVdj_prediction_results_at_" + set + ".csv"
