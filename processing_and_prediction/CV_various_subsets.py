...
for idx, (external_train_index, external_test_index) in enumerate(external_fold.split(indeces, indeces)):
    ...
    results_by_structure.to_csv("path_to_folder/PDB_set/CV/PDB_CV_results-" + str(combo_to_run) + "-roc-singlePred-fold" + str(idx) + "_" + today + ".csv")
    # print(results_by_structure)

print(CV_results)
CV_results.to_csv("path_to_folder/PDB_set/CV/PDB_CV_results-" + str(combo_to_run) + "-roc_" + today + ".csv")
