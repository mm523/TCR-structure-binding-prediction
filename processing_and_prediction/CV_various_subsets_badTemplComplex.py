...
distances = pd.read_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/PDB_set_badTemplComplex_t" + templ_thresh + "_linearised_distances.csv", index_col = 0)
fa_atr = pd.read_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/PDB_set_badTemplComplex_t" + templ_thresh + "_linearised_atr.csv", index_col = 0)
fa_elec = pd.read_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/PDB_set_badTemplComplex_t" + templ_thresh + "_linearised_elec.csv", index_col = 0)
fa_sol = pd.read_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/PDB_set_badTemplComplex_t" + templ_thresh + "_linearised_sol.csv", index_col = 0)
fa_rep = pd.read_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/PDB_set_badTemplComplex_t" + templ_thresh + "_linearised_rep.csv", index_col = 0)
atchley = pd.read_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/PDB_set_badTemplComplex_t" + templ_thresh + "_linearised_AF.csv", index_col = 0)
templ = pd.read_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/PDB_set_badTemplComplex_t" + templ_thresh + "_linearised_templates.csv", index_col = 0)
...
for idx, (external_train_index, external_test_index) in enumerate(external_fold.split(indeces, indeces)):
    ...
    results_by_structure.to_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/CV/PDB_CV_results-" + str(combo_to_run) + "_t" + templ_thresh + "-roc-singlePred-fold" + str(idx) + "_" + today + ".csv")
    # print(results_by_structure)

print(CV_results)
CV_results.to_csv("path_to_folder/PDB_set_badTemplComplex_t" + templ_thresh + "/CV/PDB_CV_results-" + str(combo_to_run) + "_t" + templ_thresh + "-roc_" + today + ".csv")
